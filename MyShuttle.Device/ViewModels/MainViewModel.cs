...
using MyShuttle.Device.IoTSender;
...
namespace MyShuttle.Device.ViewModels
{
    ...
    {
        private int _GPSCoordinatesTimerCount;
        private int _MaxNumberGPSCoordinatesPerVehicle = 17;
        ...
        private GPSCoordinatesEvent _gpsCoordEvent;
        ...
        public GPSCoordinatesEvent GPSCoordinatesEvent
        {
            get { return _gpsCoordEvent; }
            set
            {
                _gpsCoordEvent = value;
                NotifyOfPropertyChange(() => GPSCoordinatesEvent);
            }
        }
        ...
        private void DriverLogin()
        {
            ...
            string vehicleId = CurrentDriver.Id.ToString();
        ...
        //(CDLTLL) Timers and default seconds
        private void StartTimers()
        {
            if (_compassEventTimer == null)
            {
                _compassEventTimer = new DispatcherTimer { Interval = TimeSpan.FromSeconds(2) };
                _compassEventTimer.Tick += GPSCoordinatesEventTimerTickHandler;
            }
        ...
        ////////////////////////////////////////////////////////////////////// 
        //(CDLTLL - Getting Sample GPSCoordinates)
        private void GPSCoordinatesEventTimerTickHandler(object sender, EventArgs e)
        {
            _GPSCoordinatesTimerCount = _GPSCoordinatesTimerCount % Properties.Settings.Default.NumDataRegisters;

            if (_GPSCoordinatesTimerCount >= _MaxNumberGPSCoordinatesPerVehicle)
                _GPSCoordinatesTimerCount = 0;

            //Get sample coordinates            
            GPSCoordinatesEvent = DataService.GetGPSDrivingData(_GPSCoordinatesTimerCount, CurrentDriver.Id.ToString());
                        
            Sender.SendEventDirectToServiceFabricMicroservice(GPSCoordinatesEvent);

            _GPSCoordinatesTimerCount++;
        }
